	...
	<div class="fullwrap header-bg">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">Rajshahi Padma Garden</h2><br>
				
			</div>

			<div class="row-one">
				<div class="col">
					<a href=""><img src="rajshahi/padma3.jpg" alt="img" /></a>
				</div>
				<div class="col">
					<a href=""><img src="rajshahi/padm2.jpg" alt="" /></a>
					<h3></h3>
				</div>	
				<div class="col">	
