  ...
  <div class="fullwrap header-bg">
    ...
    <div class="wrap">
      <div class="header-area"> 
        <h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">Ahasan Mangil </h2><br>
        
      </div>

      <div class="row-one">
        <div class="col">
          <a href=""><img src="img/dha/17.jpg" alt="img" /></a>
          <h3> </h3>
        </div>
        <div class="col">
          <a href=""><img src="img/dha/18.jpg" alt="" /></a>
          <h3></h3>
        </div>  
        <div class="col"> 
          <a href=""><img src="img/dha/19.jpg" alt="" /></a>
          <h3></h3>
        </div>  
      </div>
...
<br><br>
<h2><strong>About Ahsan Manzil</strong></h2>
