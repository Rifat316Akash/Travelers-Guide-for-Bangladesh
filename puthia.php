	...
	<div class="fullwrap header-bg">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">Puthia Rajbari</h2><br>
				
			</div>

			<div class="row-one">
				<div class="col">
					<a href=""><img src="rajshahi/puthia1.jpg" alt="img" /></a>
					<h3>Shib Temple</h3>
				</div>
				<div class="col">
					<a href=""><img src="rajshahi/puthia2.jpg" alt="" /></a>
					<h3>Rajbari</h3>
				</div>	
				<div class="col">	
					<a href=""><img src="rajshahi/puthia3.jpg" alt="" /></a>
					<h3> Soshi Lojj</h3>
				</div>	
			</div>
			<div class="row-tow">
				<div class="col">
					<a href=""><img src="rajshahi/puthia4.jpg" alt="" /></a>
					<h3>Front Side of Rajbari</h3>
				</div>
				<div class="col">
					<a href=""><img src="rajshahi/puthia5.jpg" alt="" /></a>
					<h3>Dighi</h3>
				</div>
				<div class="col">
