      ...
      <div class="header-top">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">Lalkhal-Jaflong</h2><br>
				
			</div>

			<div class="row-one">
				<div class="col">
					<a href=""><img src="img/sylhet/sylhet1.jpg" alt="img" /></a>
					<h3> </h3>
				</div>
				<div class="col">
					<a href=""><img src="img/sylhet/sylhet2.jpg" alt="" /></a>
					<h3></h3>
				</div>	
				<div class="col">	
					<a href=""><img src="img/sylhet/sylhet3.jpg" alt="" /></a>
					<h3></h3>
				</div>	
			</div>
			<div class="row-tow">
				<div class="col">
					<a href=""><img src="img/sylhet/sylhet4.jpg" alt="" /></a>
					<h3></h3>
				</div>
				<div class="col">
					<a href=""><img src="img/sylhet/sylhet5.jpg" alt="" /></a>
					<h3></h3>
				</div>
				<div class="col">
					<a href=""><img src="img/sylhet/sylhet6.jpg" alt="" /></a>
					<h3></h3>
				</div>
			</div>
