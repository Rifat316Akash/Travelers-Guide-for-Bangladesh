      ...
      <div class="header-top">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">Bandarbans  </h2><br>
				
			</div>

			<div class="row-one">
				<div class="col">
					<a href=""><img src="img/ctg/bandor1.jpg" alt="img" /></a>
					<h3> </h3>
				</div>
				<div class="col">
					<a href=""><img src="img/ctg/bandor2.jpg" alt="" /></a>
					<h3>Boga lake</h3>
				</div>	
				<div class="col">	
					<a href=""><img src="img/ctg/bandor3.jpg" alt="" /></a>
					<h3></h3>
				</div>	
			</div>
			<div class="row-tow">
				<div class="col">
					<a href=""><img src="img/ctg/bandor4.jpg" alt="" /></a>
					<h3></h3>
				</div>
				<div class="col">
					<a href=""><img src="img/ctg/bandor5.jpg" alt="" /></a>
					<h3></h3>
				</div>
				<div class="col">
...
<br><br>
The following is a list of mountain ranges in the area and the tallest peaks of each range:<br>

Muranja (also known as Meranja) range (Basitaung, 664m)<br>
Wayla range (most of this range is in Myanmar)<br>
Chimbook range (Tindu, 898m)<br>
Batimain range (Batitaung, 526m)<br>
Politai range (Keokradang, 884m; Ramiu Taung 921m)<br>
Saichal-Mowdok range (Bilaisari, 669m; Mowdok Mual 1,003m)<br>
Saichal range (Waibung 808m; Rang Tlang, 958m; Mowdok Tlang, 905m)<br>
Wailatong and Tambang ranges<br>
